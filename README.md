...
I probably won't work much on this anymore but here are some issues/problems with it for anybody who wanted to use it as a starting point: UPDATE going to keep working on this when i have
